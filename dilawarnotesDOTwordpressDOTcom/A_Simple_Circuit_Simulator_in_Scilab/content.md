...
For example, see the following file 2.1. [sourcecode] \# Dilawar -
...
resistance. Index[4] is name of the component.Index[5] // is the upper
...
5) then nonDiagR = nonDiagR + 1/evstr(rS((p-1)\*7 + 6)); // conductance.
